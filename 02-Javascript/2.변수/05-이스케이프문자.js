...
console.log("숫자값 출력하기=%d", str); //숫자가 아님,NaN
console.log("숫자값 출력하기=%d", true); //1(0은 거짓,0이외의 모든수는 참)
console.log("숫자값 출력하기=%d", obj); //숫자가 아님,NaN
console.log("숫자값 출력하기=%d", arr); //숫자가 아님,NaN
console.log("숫자값 출력하기=%d", json); //숫자가 아님,NaN
console.groupEnd();
